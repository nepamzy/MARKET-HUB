-- CreateEnum
CREATE TYPE "PlatformRole" AS ENUM ('PLATFORM_ADMIN', 'CUSTOMER', 'DRIVER');

-- CreateEnum
CREATE TYPE "BusinessType" AS ENUM ('PRODUCER_MANUFACTURER', 'WHOLESALER', 'RETAILER', 'DIRECT_BUSINESS', 'LOGISTICS_COMPANY');
...
-- CreateIndex
CREATE INDEX "organizations_businessType_idx" ON "organizations"("businessType");
